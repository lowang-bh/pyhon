...
try:
    ...
    try:
        ...
        handler.setFormatter(logging.Formatter("[%(levelname)s] %(asctime)s,%(lineno)4d, %(funcName)s : %(message)s",
                                               "%d/%b/%Y:%H:%M:%S %z"))
...
class Card(object):
    ...
    def get_chip_dbi_shelf_slot(self):
        ...
        '''
        log.info("In Card: get_chip_dbi_shelf_slot ")

    def dbi_plug_unplug(self, *args, **kwargs):
        log.info("In Card: dbi_plug_unplug ")
        print(args, kwargs)
        a = kwargs['a']
        b = kwargs['b']
    ...
    def do_final_check(self):
        log.info("do_final_check: in Card Class")
...
class XsmCard(Card):
    ...
    def get_chip_dbi_shelf_slot(self):
        ...
        get dbi slot in chipsim
        '''
        log.info("In XSMcard: get_chip_dbi_shelf_slot")

    def do_final_check(self):
        log.info("do_final_check: in XsmCard Class")
...
class LineCard(Card):
    ...
    def do_final_check(self):
        log.info("do_final_check: in LineCard Class")
...
class PtimCard(XsmCard, LineCard):
    ...
    def do_final_check(self):
        ...
        log.info("do_final_check: in PtimCard Class")
...
class HvAccess(object):
    ...
    def __new__(cls, *args, **kwds):
        ...
        '''
        log.info("In self.__new__ function")
